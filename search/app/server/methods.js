...
const getLocalSearchField = (typeParam) => {
  ...
  switch (typeParam) {
    ...
    case 'users':
      ...
      break;
    case 'products':
      fields = ['name^7', 'description^4'];
      break;
    case 'productvariants':
      fields = ['code^9', 'originVariantCode^9', 'name^5', 'description^4', 'supplierCode^2', 'onlineId^3', 'productName^2'];
      break;
  }
  return fields;
};
...
const constructQueryObject = (typeParam, searchParam, authProfile) => {
  ...
  return {
    size: process.env['MAX_SEARCH_COUNT'] || 99999999,
    index: indexType[0],
    type: indexType[1],
    body
  };
