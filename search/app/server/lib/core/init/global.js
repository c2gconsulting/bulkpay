...
SearchService.generics = ['locations', 'products', 'customers', 'pricelists', 'productvariants'];
SearchService.nonGenerics = ['users', 'orders', 'promotions', 'promotionrebates', 'returnorders', 'payments', 'shipments', 'customertransactions', 'invoices'];


SearchService.documentCount = 500;
SearchService.bulkPushInterval = 'every 2 mins';
