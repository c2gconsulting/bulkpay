Core.Schemas.GoodsReceivedOrderItem = new SimpleSchema({
  _id: {
    type: String,
 ...
 */
Core.Schemas.GoodsReceivedNote = new SimpleSchema({
  _id: {
    type: String,
    optional: true
  },
  ...
  status: {
    type: String,
    allowedValues: ["open", "received", "cancelled"],
    index: 1,
    optional: true,
    custom: function() {
  ...
  items: {
    type: [Core.Schemas.GoodsReceivedOrderItem],
    minCount: 1
  },
  isPickup: {
    type: Boolean,
