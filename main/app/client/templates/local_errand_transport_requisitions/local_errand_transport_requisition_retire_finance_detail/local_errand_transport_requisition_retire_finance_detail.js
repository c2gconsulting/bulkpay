...
/*****************************************************************************/
/* LocalErrandTransportRequisitionFinanceRetireDetail: Event Handlers */
/*****************************************************************************/
import _ from 'underscore';

Template.LocalErrandTransportRequisitionFinanceRetireDetail.events({
    'click #approve': (e, tmpl) => {
      ...
      currentLocalErrandTransportRequest.retirementStatus = "Retirement Approved Finance";


     Meteor.call('LocalErrandTransportRequest/financeRetirements', currentLocalErrandTransportRequest, (err, res) => {
         if (res){
             swal({
     ...
     'click #reject': (e, tmpl) => {
         ...
         let currentLocalErrandTransportRequest = tmpl.currentLocalErrandTransportRequest.curValue;
         currentLocalErrandTransportRequest.budgetHolderRetirementComment = $("#budgetHolderRetirementComment").val();
         currentLocalErrandTransportRequest.retirementStatus = "Retirement Rejected Finance";
...
/*****************************************************************************/
/* LocalErrandTransportRequisitionFinanceRetireDetail: Helpers */
/*****************************************************************************/
Template.LocalErrandTransportRequisitionFinanceRetireDetail.helpers({
...
/*****************************************************************************/
/* LocalErrandTransportRequisitionFinanceRetireDetail: Lifecycle Hooks */
/*****************************************************************************/
Template.LocalErrandTransportRequisitionFinanceRetireDetail.onCreated(function () {
    let self = this;
...
Template.LocalErrandTransportRequisitionFinanceRetireDetail.onRendered(function () {
...
Template.LocalErrandTransportRequisitionFinanceRetireDetail.onDestroyed(function () {
});
