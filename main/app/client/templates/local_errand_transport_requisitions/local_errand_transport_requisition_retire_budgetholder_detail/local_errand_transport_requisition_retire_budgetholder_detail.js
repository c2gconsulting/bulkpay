...
/*****************************************************************************/
/* LocalErrandTransportRequisitionBudgetHolderRetireDetail: Event Handlers */
/*****************************************************************************/
import _ from 'underscore';

Template.LocalErrandTransportRequisitionBudgetHolderRetireDetail.events({
    'click #approve': (e, tmpl) => {

      let currentLocalErrandTransportRequest = tmpl.currentLocalErrandTransportRequest.curValue;
      currentLocalErrandTransportRequest.budgetHolderRetirementComment = $("#budgetHolderRetirementComment").val();
      currentLocalErrandTransportRequest.retirementStatus = "Retirement Approved By Budget Holder";


     Meteor.call('LocalErrandTransportRequest/budgetHolderRetirements', currentLocalErrandTransportRequest, (err, res) => {
         if (res){
             swal({
     ...
     'click #reject': (e, tmpl) => {
         ...
         let currentLocalErrandTransportRequest = tmpl.currentLocalErrandTransportRequest.curValue;
         currentLocalErrandTransportRequest.budgetHolderRetirementComment = $("#budgetHolderRetirementComment").val();
         currentLocalErrandTransportRequest.retirementStatus = "Retirement Rejected By Budget Holder";
...
/*****************************************************************************/
/* LocalErrandTransportRequisitionBudgetHolderRetireDetail: Helpers */
/*****************************************************************************/
Template.LocalErrandTransportRequisitionBudgetHolderRetireDetail.helpers({
...
/*****************************************************************************/
/* LocalErrandTransportRequisitionBudgetHolderRetireDetail: Lifecycle Hooks */
/*****************************************************************************/
Template.LocalErrandTransportRequisitionBudgetHolderRetireDetail.onCreated(function () {
    let self = this;
...
Template.LocalErrandTransportRequisitionBudgetHolderRetireDetail.onRendered(function () {
...
Template.LocalErrandTransportRequisitionBudgetHolderRetireDetail.onDestroyed(function () {
});
