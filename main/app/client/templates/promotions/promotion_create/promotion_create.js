...
/*****************************************************************************/
/* PromotionCreate: Event Handlers */
/*****************************************************************************/

Template.PromotionCreate.events({
  ...
  'click #create-promotion': function(e, tmpl) {
    ...
    tmpl.$('#create-promotion').text('SUBMITTING...');
    tmpl.$('#create-promotion').attr('disabled', true);
    
    try {
      let l = Ladda.create(tmpl.$('#create-promotion')[0]);
      l.start();
    } catch(e) {
      console.log(e);
    }
    ...
    Meteor.call('promotions/create', promotion, function(error, result) {
      ...
      tmpl.$('#create-promotion').text('Submit Promotion ');
      ...
      if (error) {
        ...
        swal({
          title: "Success",
          text: `Promotion has been created`,
  ...
  'click #cancel-promotion': function(e, tmpl) {
    swal({
      ...
      function() {
        ...
        swal({
          title: "Cancelled",
          text: "Your draft promotion has been deleted.",
...
/*****************************************************************************/
/* PromotionCreate: Helpers */
/*****************************************************************************/
Template.PromotionCreate.helpers({
  promotion: function() {
    return getPromotion();
  },
...
/*****************************************************************************/
/* PromotionCreate: Lifecycle Hooks */
/*****************************************************************************/
Template.PromotionCreate.onCreated(function() {
...
Template.PromotionCreate.onRendered(function() {
  $('.selectpicker').selectpicker('show');
});

Template.PromotionCreate.onDestroyed(function() {});
