/*****************************************************************************/
/* LineDiscount: Event Handlers */
/*****************************************************************************/
Template.LineDiscount.events({
...
/*****************************************************************************/
/* LineDiscount: Helpers */
/*****************************************************************************/
Template.LineDiscount.helpers({

});

/*****************************************************************************/
/* LineDiscount: Lifecycle Hooks */
/*****************************************************************************/
Template.LineDiscount.onCreated(function() {
...
Template.LineDiscount.onRendered(function() {
  $('.selectpicker').selectpicker('show');
  $('.loading-' + this.data.index).hide();
});

Template.LineDiscount.onDestroyed(function() {});
