/*****************************************************************************/
/* StockTransfersList: Event Handlers */
/*****************************************************************************/
Template.StockTransfersList.events({
...
/*****************************************************************************/
/* StockTransfersList: Helpers */
/*****************************************************************************/
Template.StockTransfersList.helpers({
    ...
    transfers: function() {
        return Template.instance().transfers();
    }
});

/*****************************************************************************/
/* StockTransfersList: Lifecycle Hooks */
/*****************************************************************************/
Template.StockTransfersList.onCreated(function () {
    ...
    instance.autorun(function () {
        ...
        let subscription = instance.subscribe('StockTransfers', sort, limit);
    ...
    instance.transfers = function() {
        ...
        return StockTransfers.find({}, options);
    };
});

Template.StockTransfersList.onRendered(function () {
...
Template.StockTransfersList.onDestroyed(function () {
