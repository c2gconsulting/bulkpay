...
/*****************************************************************************/
/* singleBuUnit: Lifecycle Hooks */
/*****************************************************************************/
Template.singleBuUnit.onCreated(function () {
    let self = this;
    //console.log(`Inside singleBuUnit onCreated. biz unit id: ${self.data.data._id}`)
...
Template.singleBuUnit.onRendered(function () {
});

Template.singleBuUnit.onDestroyed(function () {
});
