...
/*****************************************************************************/
/* TravelRequisition2LogisticsRetirementDetail: Event Handlers */
/*****************************************************************************/
import _ from 'underscore';

Template.TravelRequisition2LogisticsRetirementDetail.events({
    'click #approve': (e, tmpl) => {

      let currentTravelRequest = tmpl.currentTravelRequest.curValue;
      currentTravelRequest.supervisorRetirementComment = $("#supervisorRetirementComment").val();
      currentTravelRequest.retirementStatus = "Retirement Approved By Logistics";


     Meteor.call('TRIPREQUEST/logisticsRetirements', currentTravelRequest, (err, res) => {
         if (res){
             swal({
                 title: "Trip retirement has been Approved By Logistics",
     ...
     'click #reject': (e, tmpl) => {
         ...
         let currentTravelRequest = tmpl.currentTravelRequest.curValue;
         currentTravelRequest.supervisorRetirementComment = $("#supervisorRetirementComment").val();
         currentTravelRequest.retirementStatus = "Retirement Rejected By Logistics";

      Meteor.call('TRIPREQUEST/logisticsRetirements', currentTravelRequest, (err, res) => {
          if (res){
              swal({
                  title: "Trip retirement has been Rejected By Logistics",
                  text: "Employee retirement has been updated,notification has been sent to the necessary parties",
                  confirmButtonClass: "btn-success",
                  type: "success",
                  confirmButtonText: "OK"
...
/*****************************************************************************/
/* TravelRequisition2LogisticsRetirementDetail: Helpers */
/*****************************************************************************/
Template.TravelRequisition2LogisticsRetirementDetail.helpers({
    ACTIVITY: () => 'activityId',
...
/*****************************************************************************/
/* TravelRequisition2LogisticsRetirementDetail: Lifecycle Hooks */
/*****************************************************************************/
Template.TravelRequisition2LogisticsRetirementDetail.onCreated(function () {
    let self = this;
...
Template.TravelRequisition2LogisticsRetirementDetail.onRendered(function () {
...
Template.TravelRequisition2LogisticsRetirementDetail.onDestroyed(function () {
});
