...
/*****************************************************************************/
/* TravelRequisition2BookingAgent: Event Handlers */
/*****************************************************************************/
...
Template.TravelRequisition2BookingAgent.helpers({
  ...
  'getEmployeePhoneNumber': function(employeeId) {
    ...
    requisitionId: function () {
        return Router.current().params.query.requisitionId
    },
...
/*****************************************************************************/
/* TravelRequisition2BookingAgent: Lifecycle Hooks */
/*****************************************************************************/
Template.TravelRequisition2BookingAgent.onCreated(function () {
    let self = this;
...
Template.TravelRequisition2BookingAgent.onRendered(function () {
...
Template.TravelRequisition2BookingAgent.onDestroyed(function () {
});
