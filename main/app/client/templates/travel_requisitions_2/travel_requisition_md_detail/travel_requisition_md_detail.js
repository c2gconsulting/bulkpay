...
/*****************************************************************************/
/* TravelRequisition2MDDetail: Event Handlers */
/*****************************************************************************/
...
Template.TravelRequisition2MDDetail.events({
    ...
    'click #reject': (e, tmpl) => {
        ...
        if (fieldsAreValid){
            ...
            Template.instance().errorMessage.set(null);
            Modal.hide('TravelRequisition2MDDetail');
        }else{
            swal({
                title: "Oops!",
                text: "Validation errors" + validationErrors,
...
/*****************************************************************************/
/* TravelRequisition2MDDetail: Helpers */
/*****************************************************************************/
Template.TravelRequisition2MDDetail.helpers({
    ...
    canApprove() {
        const currentTravelRequest = Template.instance().currentTravelRequest.get();
        const { MD } = Core.Approvals;
        return Core.canApprove(MD, currentTravelRequest)
    },
    travelTypeChecked(val){
        const currentTravelRequest = Template.instance().currentTravelRequest.get();
        if(currentTravelRequest && val){
...
/*****************************************************************************/
/* TravelRequisition2MDDetail: Lifecycle Hooks */
/*****************************************************************************/
Template.TravelRequisition2MDDetail.onCreated(function () {
...
Template.TravelRequisition2MDDetail.onRendered(function () {
...
Template.TravelRequisition2MDDetail.onDestroyed(function () {
});
