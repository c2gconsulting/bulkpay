...
/*****************************************************************************/
/* TravelRequisition2LogisticsDetail: Event Handlers */
/*****************************************************************************/
import _ from 'underscore';


Template.TravelRequisition2LogisticsDetail.events({
  ...
  'click #processTrip': (e, tmpl) => {
    ...
    currentTravelRequest.status = "Processed By Logistics";
...
/*****************************************************************************/
/* TravelRequisition2LogisticsDetail: Helpers */
/*****************************************************************************/
Template.TravelRequisition2LogisticsDetail.helpers({
    ACTIVITY: () => 'activityId',
    ...
    canRetryJournal() {
        const currentTravelRequest = Template.instance().currentTravelRequest.get();
        const { LOGISTICS } = Core.Approvals;
        return !Core.canApprove(LOGISTICS, currentTravelRequest) && !currentTravelRequest.journalPosted;
    },
...
/*****************************************************************************/
/* TravelRequisition2LogisticsDetail: Lifecycle Hooks */
/*****************************************************************************/
Template.TravelRequisition2LogisticsDetail.onCreated(function () {
...
Template.TravelRequisition2LogisticsDetail.onRendered(function () {
...
Template.TravelRequisition2LogisticsDetail.onDestroyed(function () {
});
