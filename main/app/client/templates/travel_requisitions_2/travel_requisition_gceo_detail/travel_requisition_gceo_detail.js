...
/*****************************************************************************/
/* TravelRequisition2GCEODetail: Event Handlers */
/*****************************************************************************/
import _ from 'underscore';

Template.TravelRequisition2GCEODetail.events({
    'click #approve': (e, tmpl) => {
        let gceoComment = $('[name=gceoComment]').val();
        let budgetCodeId =$('[name=budget-code]').val();

        let currentTravelRequest = tmpl.currentTravelRequest.curValue;
        currentTravelRequest.gceoComment = gceoComment;
        currentTravelRequest.budgetCodeId = budgetCodeId;
        currentTravelRequest.status = Core.ALL_TRAVEL_STATUS.APPROVED_BY_GCEO;

        currentTravelRequest.businessUnitId = Session.get('context'); //set the business unit id one more time to be safe

        e.preventDefault()

        //update gceoComment one last final time
        currentTravelRequest.gceoComment = $("#gceoComment").val();
    ...
    'click #reject': (e, tmpl) => {
        ...
        currentTravelRequest.gceoComment = gceoComment;
        currentTravelRequest.budgetCodeId = budgetCodeId;
        currentTravelRequest.status = Core.ALL_TRAVEL_STATUS.REJECTED_BY_GCEO;
...
/*****************************************************************************/
/* TravelRequisition2GCEODetail: Lifecycle Hooks */
/*****************************************************************************/
Template.TravelRequisition2GCEODetail.onCreated(function () {
...
Template.TravelRequisition2GCEODetail.onRendered(function () {
...
Template.TravelRequisition2GCEODetail.onDestroyed(function () {
});
