...
Template.TravelRequisition2FinanceRetireIndex.helpers({
    ...
    'numberOfPages': function() {
        ...
        let totalNum = TravelRequisition2s.find({$and : [
            ...
            { $or : [ { retirementStatus : "Retirement Approved By HOD" }, { retirementStatus : "Retirement Approved Budget Holder" }, { retirementStatus : "Retirement Approved Finance" }, { retirementStatus : "Retirement Rejected Finance"}] }
        ]}).count()
...
Template.TravelRequisition2FinanceRetireIndex.onCreated(function () {
    ...
    self.getTravelRequestsByFinanceApprover = function(skip) {
        ...
        return TravelRequisition2s.find({
            $and : [
                { financeApproverId: Meteor.userId()},
                { $or : [ { retirementStatus : "Retirement Approved By HOD" }, { retirementStatus : "Retirement Approved Finance" }, { retirementStatus : "Retirement Rejected Finance"}] }
            ]
        }, options);
    }
