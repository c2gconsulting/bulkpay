/*****************************************************************************/
/* TravelRequisition2BSTRetirementIndex: Event Handlers */
/*****************************************************************************/
import _ from 'underscore';

Template.TravelRequisition2BSTRetirementIndex.events({
    ...
    'click .requisitionRow': function(e, tmpl) {
        ...
        Modal.show('TravelRequisition2BSTRetirementDetail', invokeReason)
    },
...
/*****************************************************************************/
/* TravelRequisition2BSTRetirementIndex: Helpers */
/*****************************************************************************/
Template.TravelRequisition2BSTRetirementIndex.helpers({
    ...
    'numberOfPages': function() {
        ...
        let totalNum = TravelRequisition2s.find({$and : [
            ...
            { $or : [{ retirementStatus : "Retirement Approved Finance" }, { retirementStatus : "Retirement Approved BST" }, { retirementStatus : "Retirement Rejected BST"}] }
        ]}).count()
...
/*****************************************************************************/
/* TravelRequisition2BSTRetirementIndex: Lifecycle Hooks */
/*****************************************************************************/
Template.TravelRequisition2BSTRetirementIndex.onCreated(function () {
    let self = this;
    ...
    self.getTravelRequestsByBST = function(skip) {
        ...
        return TravelRequisition2s.find({
            $and : [
                { supervisorId: Meteor.userId()},
                { $or : [{ retirementStatus : "Retirement Approved Finance" }, { retirementStatus : "Retirement Approved by BST" }, { retirementStatus : "Retirement Rejected By BST"}] }
            ]
        }, options);
    }
...
Template.TravelRequisition2BSTRetirementIndex.onRendered(function () {
    $('select.dropdown').dropdown();
    $("html, body").animate({ scrollTop: 0 }, "slow");
});

Template.TravelRequisition2BSTRetirementIndex.onDestroyed(function () {
});
